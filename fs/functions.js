...
const simih = async (text) => {
	try {
		const sami = await fetch(`https://api.simsimi.net/v1/?text=${text}&lang=id`, {method: 'GET'})
...
module.exports = { _wait, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, close }
